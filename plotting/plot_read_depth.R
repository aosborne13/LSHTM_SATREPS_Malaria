...
# plot snps on all genes
lablist<-as.vector(c("N51I", "C59R", "S108N", "I164L", "S436H", "G437A", "K540E", "A581G", "A613S",
                     "F61Y", "N86Y", "Y184F", "T199S", "F938Y", "S1034C", "N1042D", "F1072Y", "D1246Y",
                     "C72S","V73-", "M74I", "N75E", "K76T", "R146K", "S160N", "F446I", "N458Y", "M476I",
                     "Y493H", "R539T", "I543T", "P553L", "R561H", "A578S", "C580Y"))

pdf("/home/ashley/Documents/amplicon_sequencing/Ngodhe_MDA/plots/read_depth_all_genes_NG8.pdf")
boxplot(depth %>% select(c(Asn51, Cys59, Ser108, Ile164, Ser436, Gly437, Lys540, Ala581, Ala613,
                           Phe61, Asn86, Tyr184, Thr199, Phe938, Ser1034, Asn1042, Phe1072, Asp1246, Met74,
                           Cys72, Val73, Asn75, Lys76, Arg146, Ser160, Phe446, Asn458, Met476, Tyr493, Arg539, 
                           Ile543, Pro553, Arg561, Ala578, Cys580)), pars  =  list(xaxt = "n"), ylab = "Read Depth", 
        col = c('green', 'green', 'green', 'green', "yellow", "yellow", "yellow", "yellow", "yellow", 
                "orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange", 
                "blue", "blue", "blue", "blue", "blue", "purple", "purple",
...
axis(1, at=c(1:35), labels = FALSE)
text(c(1:35), par("usr")[3] - 1, labels = lablist, srt = 55, pos = 1, offset= 1.6, xpd = TRUE, cex = 0.8)
legend("topleft",inset=c(0,0), col= c('green', "yellow", "orange", "blue", "purple", "red"),pch=20,leg=c("PfDHFR","PfDHPS", "PfMDR1", "PfCRT", "PfAP2MU", "PfK13"), cex=0.9)
dev.off()
